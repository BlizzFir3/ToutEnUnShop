  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
		  <a class="nav-link active" aria-current="page" href="index.php" style="font-weight: bold;">Produits</a>
        </li>
      </ul>
...
<div class="album py-5 bg-body-tertiary">
    <div class="container">
<a class="btn btn-outline-success" style="margin: 25px; display: flex; align-items: center; justify-content: center;" href="ajouter.php">Ajouter un produit</a>
		...
		<?php foreach($mesProduits as $unProduit): ?>
			<tr>
				...
				<a href="suppression.php?id=<?= $unProduit->id ?>">
					<button name="valider" onclick="return confirm('Êtes-vous sure de vouloir supprimer ce produit?');" type="button" class="btn btn-danger">Supprimer le produit</button></a>
				</td>
			</tr>
	  	<?php endforeach; ?>
		</tbody>
